...
require_once(dirname(__FILE__) . '/class.gl2tstModule.php');
require_once(dirname(__FILE__) . '/class.gl2tstTopic.php');
require_once(dirname(__FILE__) . '/class.gl2tstSection.php');
...
class gl2tstGlossary
{
    ...
    public function getProfessionTitle()
    {
        ...
        $parent = $tree->getParentNodeData($this->glossary->getRefId());
    ...
    public static function getAllGlossaries()
    {
        ...
        $sql = "SELECT object_reference.ref_id, category_data.title FROM object_data AS glossary_data " .
            ...
            "INNER JOIN object_data AS category_data ON (category_data.obj_id = category_ref.obj_id) " .
            "WHERE " .
            "glossary_data.type = 'glo' " .
            "AND glossary_data.title LIKE '%Offizielle Prüfungsfragen%' " .
            "AND category_data.type = 'cat' " .
            "AND object_reference.deleted IS NULL " .
            "AND category_ref.deleted IS NULL";
        $set = $ilDB->query($sql);
        $return = array();
