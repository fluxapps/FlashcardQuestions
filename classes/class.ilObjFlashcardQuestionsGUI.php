...
class ilObjFlashcardQuestionsGUI extends ilObjectPluginGUI {
	...
	public function performCommand(string $cmd)/*: void*/ {
		...
		switch (strtolower($next_class)) {
            case strtolower(ilObjTaxonomyGUI::class):
                switch ($cmd) {
                    case 'listTaxonomies':
                        self::dic()->ctrl()->redirect($this, self::CMD_SHOW_CONTENTS); // TODO: mit nextclass
                        break;
                    default:
	...
	protected function setTabs()/*: void*/ {
        ...
        if (ilObjFlashcardQuestionsAccess::hasWriteAccess()) {
            ...
            self::dic()->tabs()->addTab(self::TAB_TAXONOMY, self::plugin()->translate("taxonomy", self::LANG_MODULE_OBJECT), self::dic()->ctrl()
